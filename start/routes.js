...
//  * Cashier/Staff
//  */
Route.get('/staff/users/:id', 'StaffController.index').middleware(['auth', 'staff'])
Route.get('/staff/users', 'StaffController.show').middleware(['auth', 'staff'])
Route.get('/staff/accounts', 'StaffController.showAccounts').middleware(['auth', 'staff'])
Route.get('/staff/accounts/:id', 'StaffController.indexAccount').middleware(['auth', 'staff'])
...
Route.get('/admin/users/:id', 'AdminController.user').middleware(['auth', 'admin'])
